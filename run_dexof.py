...
path_stl = './cfd_sim/stl_cfd/'
base_dexfile='./cfd_sim/rough_mesh_8cores.dex'
design_set_load= np.loadtxt('./cfd_sim/rudder_design_points.csv', delimiter = ",")
result_folder='./cfd_sim/result_logs'
